...
```{r}
tecator_short <- read.table("~/Documents/Github/Griffen_et_al_Supplemental/Version3.0/tecator_short.txt")

# Reshape the data
tecator1 <- t(matrix(tecator_short, nrow = 125, ncol = 240))

# Extract data and target
data <- data.frame(tecator1[1:172, 1:100])
...
```{r}
library(BAS)
tecator.amc = bas.lm(target ~ ., data=data, prior="gprior", alpha = 100, method = "AMCMC", 
                     burnin.iterations = 10000,
